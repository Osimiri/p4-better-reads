...
def make_author():
    ...
    authors = [
        ...
        Author(full_name="Fonda Lee", biography="Fonda Lee is the World Fantasy Award-winning author of the epic Green Bone Saga, beginning with Jade City and continuing in Jade War and Jade Legacy. She is also the author of the acclaimed science fiction novels Zeroboxer, Exo and Cross Fire.Fonda is as a three-time winner of the Aurora Award (Canada’s national science fiction and fantasy award), and a multiple finalist for the Nebula Award, the Locus Award, and the Oregon Book Award. Her novels have garnered multiple starred reviews, been included on numerous state reading lists, named Junior Library Guild selections, and appeared on Best of Year lists from NPR, Barnes & Noble, Syfy Wire, and others.", author_image= " https://images.gr-assets.com/authors/1428795279p5/7705004.jpg"),
        ...
        Author(full_name="Neal Stephenson", biography="Neal Stephenson is the author of Reamde, Anathem, and the three-volume historical epic the Baroque Cycle (Quicksilver, The Confusion, and The System of the World), as well as Cryptonomicon, The Diamond Age, Snow Crash, and Zodiac. He lives in Seattle, Washington.", author_image= " https://images.gr-assets.com/authors/1430920344p5/545.jpg"),

        Author(full_name="Sandle Brandleman", biography="Sandle Brandleman was born in a small town in rural Kansas, but always dreamed of bigger things. After studying English at university, she moved to New York City and began her career as a writer. Her debut novel, a sweeping family drama set in the American Midwest, was a critically acclaimed bestseller.", author_image= "")
