...
def make_genre():
    ...
    'Poetry', 'Science Fiction', 'Non-Fiction', 'Biography', 'Autobiography', 'Art']
...
def make_author():
    ...
    "Andrew Loomis", "Colleen Hoover", "Chris Bohjalian", "Chuck Tingle", "Blanca Lepinska",
...
def make_book():
    ...
    Book(title="Verity", price="3.19", isbn="9781538724736", likes="0", author_id="10", genre_id="", image = "https://www.colleenhoover.com/wp-content/uploads/2023/01/Screen-Shot-2023-01-25-at-1.49.58-PM.png"),
    ...
    Book(title="365 Days", price="12.21", isbn="9781982174309", likes="0", author_id="", genre_id="", image = "https://d28hgpri8am2if.cloudfront.net/book_images/onix/cvr9781797124032/365-days-9781797124032_hr.jpg"),
    ...
    Book(title="Americanah", price="4.62", isbn="9780307455925", likes="0", author_id="15", genre_id="", image = "https://pictures.abebooks.com/isbn/9780307455925-us-300.jpg"),
    ...
    Book(title="Before the Coffee Gets Cold", price="7.99", isbn="9781529029581", likes="0", author_id="19", genre_id="", image = "https://www.westonpubliclibrary.org/main/wp-content/uploads/before-coffee-gets-cold-1351x2048.jpg" ),
